        ...
        <div id="tabs" className="flex justify-between cursor-pointer">
          {navigations.map((navigation, index) => (
            <Link key={index} href={navigation.link}>
              <div
                className={clsx(
                  "w-full flex flex-col items-center justify-center text-center hover:text-yellow-500 hover:font-semibold pt-4 bg-stone-100",
                  navigation.active && "text-indigo-600 font-semibold bg-stone-200"
                )}
              >
                <navigation.icon />
                <span
